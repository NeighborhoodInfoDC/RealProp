/**************************************************************************
 Program:  Parcel_geo_ownerpt_2016_04.sas
 Library:  RealProp
...
%let update_file = Ownerpt_2016_09;
%let update_date = 2016_09;
%let finalize  = Y;

%include "L:\Libraries\RealProp\Macros\Parcel_geo_update_new.sas";
