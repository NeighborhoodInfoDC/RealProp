...
%macro Parcel_geo_update( 
  update_file=, 
  geo_file=RealProp.Parcel_geo,
  out_file=Parcel_geo_&update_file,
  map_path=D:\DCData\Libraries\RealProp\Maps,
  ...
  ** Begin update **;
  ...
  %if &info = Y %then %do;
    ...
    %file_info( data=&info_file, 
                freqvars=geo2000 Ward2002 Anc2002 Psa2004 geo2010 Ward2012 Anc2012 Psa2012 cluster_tr2000 Cluster2000 Zip
